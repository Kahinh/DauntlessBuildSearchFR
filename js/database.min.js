const 
    cellType = ["None", "Defence", "Mobility", "Power", "Technique", "Utility"],
    weaponType = ["Aether Strikers", "Axe", "Chain Blades", "Hammer", "Repeater", "Sword", "War Pike"],
    armorType = ["Head", "Torso", "Arms", "Legs"],
    idList = ["Agarus", "Boreus", "Charrogg", "Drask", "Embermane", "Generic", "Gnasher", "Hellion", "Kharabak", "Koshai", "Malkarion", "Nayzaga", "Pangar", "Quillshot", "Rezakiri", "Riftstalker", "Shrike", "Shrowd", "Skarn", "Skraev", "Stormclaw", "Thrax", "Torgadoro", "Urska", "Valomyr", "Charrogg Exotic", "Shrowd Exotic", "Rezakiri Exotic"],
