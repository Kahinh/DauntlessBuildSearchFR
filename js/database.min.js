const 
    ...
    perkList = [
        ...
        [{
            ...
            effect: [{
                description: ["+10% Tonic Effectiveness", null],
                value: [1.1, null]
            }, {
                description: ["+20% Tonic Effectiveness", null],
                value: [1.2, null]
            }, {
                description: ["+30% Tonic Effectiveness", null],
                value: [1.3, null]
            }, {
                description: ["+40% Tonic Effectiveness", "+20% Tonic Duration"],
                value: [1.4, 1.2]
            }, {
                description: ["+50% Tonic Effectiveness", "+40% Tonic Duration"],
                value: [1.5, 1.4]
            }, {
                description: ["+60% Tonic Effectiveness", "+60% Tonic Duration"],
                value: [1.6, 1.6]
            }],
            map: 50,
            DBmap: 171,
            ...
            effect: [{
                description: ["Your Flask heals over 20 seconds", "but for 20% increased healing. While this heal is active", "generate 8 Lantern Charge each second.", null],
                value: [1.2, 8]
            }, {
                description: ["Your Flask heals over 20 seconds", "but for 20% increased healing. While this heal is active", "generate 16 Lantern Charge each second.", null],
                value: [1.2, 16]
            }, {
                description: ["Your Flask heals over 20 seconds", "but for 20% increased healing. While this heal is active", "generate 25 Lantern Charge each second.", null],
                value: [1.2, 25]
            }, {
                description: ["Your Flask heals over 20 seconds", "but for 20% increased healing. While this heal is active", "generate 37.5 Lantern Charge each second.", null],
                value: [1.2, 37.5]
            }, {
                description: ["Your Flask heals over 20 seconds", "but for 20% increased healing. While this heal is active", "generate 50 Lantern Charge each second.", null],
                value: [1.2, 50]
            }, {
                description: ["Your Flask heals over 20 seconds", "but for 20% increased healing. While this heal is active", "generate 75 Lantern Charge each second.", null],
                value: [1.2, 75]
            }],
            map: 54,
            DBmap: 135,
            ...
            effect: [{
                description: ["Your Flask heals for 30 less", "Using your Flask also heals all other Slayers for 45"],
                value: [30, 45]
            }, {
                description: ["Your Flask heals for 60 less", "Using your Flask also heals all other Slayers for 90"],
                value: [60, 90]
            }, {
                description: ["Your Flask heals for 90 less", "Using your Flask also heals all other Slayers for 135"],
                value: [90, 135]
            }, {
                description: ["Your Flask heals for 120 less", "Using your Flask also heals all other Slayers for 180"],
                value: [120, 180]
            }, {
                description: ["Your Flask heals for 150 less", "Using your Flask also heals all other Slayers for 225"],
                value: [150, 225]
            }, {
                description: ["Your Flask heals for 180 less", "Using your Flask also heals all other Slayers for 270"],
                value: [180, 270]
            }],
            map: 56,
            DBmap: 162,
