for (i = 1; i < perkList.length; i++) {
    for (document.write('<div class= "ListPerkContainer"><img class="ListPerkIcon" src="assets/icons/perks/' + cellType[i] + '.png"><h4>' + cellType[i] + "</h4>"), j = 0; j < perkList[i].length; j++) {
